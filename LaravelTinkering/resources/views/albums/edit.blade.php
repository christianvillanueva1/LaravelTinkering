...
<div class="container2">
    <h1>Edit Album</h1>
    <h2>Update the details of the album</h2>
    <form action="{{ route('albums.update', $album->id) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="singer" class="form-control" value="{{ $album->singer }}" required>
        </div>
        <div class="form-group">
            <label for="songs">Songs</label>
            <input type="number" name="songs" class="form-control" value="{{ $album->songs }}" required>
        </div>
        <div class="form-group">
